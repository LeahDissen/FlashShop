        ...
        <div className={cardClasses} onClick={() => onImageSelect && onImageSelect(image)}>
            ...
            {onAdjustPrint && (
                <button
                    ...
                    className="absolute bottom-12 left-1/2 -translate-x-1/2 z-10 opacity-0 group-hover:opacity-100 focus:opacity-100 transition-opacity bg-white/90 text-[10px] font-bold text-[#f2665e] px-2 py-1 rounded-full shadow-sm border border-[#f2665e]/30"
                >
                    תצוגה / חיתוך
                </button>
            )}
                ...
                <div className="relative">
                    ...
                    {isDropdownOpen && (
                        <>
                            ...
                            />
                            <div className="absolute top-full right-0 mt-1 w-32 bg-white rounded-md shadow-xl border border-gray-100 overflow-hidden z-20 flex flex-col">
                                {sizes.map((size) => (
                                    <button
                                        key={size.value}
                                        type="button"
